...
public class PolicyHandler {
    ...
    public void wheneverVideoStreamed_SendMessage(
        @Payload VideoStreamed videoStreamed
    ) {
        VideoStreamed event = videoStreamed;
        System.out.println(
            "\n\n##### listener SendMessage : " + videoStreamed + "\n\n"
        );
        // Sample Logic //
    ...
    public void wheneverFileUploaded_SendMessage(
        @Payload FileUploaded fileUploaded
    ) {
        FileUploaded event = fileUploaded;
        System.out.println(
            "\n\n##### listener SendMessage : " + fileUploaded + "\n\n"
        );
        // Sample Logic //
